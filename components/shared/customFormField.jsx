      ...
      return (
        <FormControl>
          <Input
            ...
            className={cn("textBig border-0 focus:border-primary", props.className, className)}
          />
        </FormControl>
      );
      ...
      return (
        <FormControl>
          <Textarea
            ...
            className={cn("shad-textArea focus:border-primary", props.className, className)}
    ...
    <FormField
      ...
      render={({ field }) => (
        <FormItem className="flex-1">
          ...
          <RenderInput
            className="text-xs lg:text-base bg-transparent border-2 rounded-md"
            field={field}
            props={props}
          />
